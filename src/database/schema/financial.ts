...
// Enums
export const financialTypeEnum = pgEnum('financial_type', ['earning', 'payment', 'withdrawal']);
export const financialStatusEnum = pgEnum('financial_status', ['pending', 'completed', 'failed']);
